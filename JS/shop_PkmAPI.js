...
const papelera = `
    ...
    <path d="M14.5 3a1 1 0 0 1-1 1H13v9a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V4h-.5a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1H6a1 1 0 0 1 1-1h2a1
        1 0 0 1 1 1h3.5a1 1 0 0 1 1 1zM4.118 4 4 4.059V13a1 1 0 0 0 1 1h6a1 1 0 0 0 1-1V4.059L11.882 4zM2.5 3h11V2h-11z"/>
    </svg>`;
...
function crearCartaCesta(pokemonID, precio) {
    ...
    <button id="eliminar" onclick="eliminarPkm('${idCompra}')">${papelera}</button>`;
...
// Vemos si está el modo oscuro activado
...
if(leido === null) {
    console.log("No hay equipo que leer");
} else {
...
crear.addEventListener("click", () => {
    ...
    window.location.href = "equipo_Pkm.html?IDs="
